...
import { getRanking } from "_action/ranking";

const AgencyDigital = () => {
  const ranking = useSelector((state) => state.RankingReducer.rank_data);
  ...
  //   router.push(`/${process.env.contextPath}/`); // Replace with the actual route within basePath
  // };
